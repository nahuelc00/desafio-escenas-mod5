    ...
    const rutas = [
        {
            ruta: /\/inbox\/../,
            accion: function() {
                const inputEl = document.querySelector(".section-main__input");
                const titleAuxEl = document.querySelector(".section-main__title-aux");
                const titleEl = document.querySelector(".section-main__title");
                const contFormEl = document.querySelector(".section-main__cont-form");
                const textEmailEl = document.querySelector(".section-main__text-email");
...
function listenerButtons() {
    ...
    otroButtonEl.addEventListener("click", (e)=>{
        const otroInputEl = document.querySelector(".section-main__otro-input");
        let url;
        if (location.pathname == "/") {
...
},{"./comp-header/header":"7z1cH","./comp-inbox/comp-inbox":"cNqif"}],"7z1cH":[function(require,module,exports) {
...
},{}],"cNqif":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
